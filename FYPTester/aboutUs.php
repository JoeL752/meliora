...
<body>
    ...
    <img src="images/newAbout.jpg" class="d-block img-fluid" alt="placeholder-img" style="width:100%">

  <div class="custDiv">
    <div class="container">
      <div class="row">
        <h2>About Us</h2>
        <p>The ethos at Meliora Medical Aesthetics is to manage client expectations realistically, use the highest quality, safe products to produce natural and age-appropriate results in a gradual and safe manner.</p>
        <h2>Staff</h2>
        <p>Hello, my name is Demetra, and I am a NMC Registered Nurse, trained in Advance Aesthetic Techniques. I run a discreet, aesthetic clinic in Shrewsbury and treat clients in strict confidence. 
I believe that aesthetic treatments should seek to enhance the individual’s natural features.  Aging is natural and I strongly believe in natural looking results.</p>
      </div>
    </div>
  </div>
