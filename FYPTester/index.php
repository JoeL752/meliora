    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="images/carousel3.jpeg" class="d-block img-fluid" alt="placeholder-img" style="opacity:0.88">
          <div class="container">
            <div class="carousel-caption">
              <h1 class="captionHeaderSize" style="color: white;">Skin and Beauty Clinic</h1>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <img src="images/clearhome2head.jpg" class="d-block img-fluid" alt="placeholder-img" style="opacity:0.88">
          <div class="container">
            <div class="carousel-caption" style="color: white;">
              <h1 class="captionHeaderSize">Skin and Beauty Clinic</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
              <img src="images/LipFiller.jpeg">
            <div class="card-body">
              <h4 class="text-center">Fillers</h4>
            </div>
          </div>
        </div>
        </a>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/MesoService.jpg">
            <div class="card-body">
              <h4 class="text-center">Mesotherapy</h4>
            </div>
          </div>
        </div>
        </a>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/WrinklePic.jpg">
            <div class="card-body">
              <h4 class="text-center">Wrinkle Softening</h4>
            </div>
          </div>
        </div>
        </a>
